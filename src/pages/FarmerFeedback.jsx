...
import { Star, Send, LayoutDashboard, Package, ShoppingBag, User, Globe } from "lucide-react";
...
const FarmerFeedback = () => {
  const [formData, setFormData] = useState({
    name: "",
    email: "",
    farmerDashboardRating: 0,
    farmerDashboardReview: "",
    farmerProductsRating: 0,
    farmerProductsReview: "",
    farmerOrdersRating: 0,
    farmerOrdersReview: "",
    farmerProfileRating: 0,
    farmerProfileReview: "",
    overallRating: 0,
    overallReview: "",
  });
  ...
  const sections = [
    { key: "user", label: "Farmer Details", icon: User, description: "Please provide your basic information" },
    { key: "farmerDashboard", label: "Farmer Dashboard", icon: LayoutDashboard, description: "How is your experience with the Farmer Dashboard?" },
    { key: "farmerProducts", label: "Farmer Products", icon: Package, description: "Share your thoughts on managing your products" },
    { key: "farmerOrders", label: "Farmer Orders", icon: ShoppingBag, description: "How easy is it to manage your orders?" },
    { key: "farmerProfile", label: "Farmer Profile Section", icon: User, description: "Your experience with the farmer profile section" },
    { key: "overall", label: "Overall Website", icon: Globe, description: "Your overall impression of HeritageBites" },
  ];
  ...
  const SectionIcon = sections[currentSection]?.icon || User;
        ...
        <div className="relative container mx-auto max-w-6xl">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            ...
            <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
              Your feedback helps us improve the farmer experience on HeritageBites. Help us build better tools for our farming community.
            </p>
          </motion.div>
        </div>
      </header>
              ...
              {currentSection === 0 && (
                ...
                >
                  <div className="text-center mb-8">
                    ...
                    <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-2">Let's Get Started</h2>
                    <p className="text-gray-600 text-lg">Please provide your basic information</p>
                  </div>
                  ...
                  <div className="flex justify-center mt-8">
                    <Button
                      ...
                      className="bg-primary hover:bg-primary/90 text-white px-8 py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                    >
              ...
              {currentSection > 0 && currentSection <= sections.length && (
                ...
                >
                  <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600 text-lg">{sections[currentSection].description}</p>
                  </div>
